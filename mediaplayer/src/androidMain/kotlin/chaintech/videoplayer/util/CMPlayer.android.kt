...
actual fun CMPPlayer(
    ...
    val exoPlayer = rememberExoPlayerWithLifecycle(url, context, isPause, isLiveStream, error, isHls)
    ...
    Box {
        AndroidView(
            ...
            update = {
                ...
                seekToTime?.let { exoPlayer.seekTo(TimeUnit.SECONDS.toMillis(it.toLong())) }
