...
import uz.mobile.joybox.presentation.screens.auth.forgotPasswordChange.ForgotPasswordChangePasswordScreen
...
class ForgotPasswordPhoneScreen : MoviesAppScreen {
    ...
    fun ForgotPasswordPhoneScreenContent(
        ...
        viewModel: ForgotPasswordPhoneViewModel = koinScreenModel(),
        ...
        LaunchedEffect(phoneState) {
            if (phoneState is PhoneForgotPasswordPhoneState.Success) {
                navigator.push(ForgotPasswordChangePasswordScreen(data = User(phone = phoneState.phone)))
        ...
        key(languageViewModel.selectedLanguage) {
            Column(
                ...
                MainButton(
                    ...
                    isLoading = phoneState is PhoneForgotPasswordPhoneState.Loading
                ) {
