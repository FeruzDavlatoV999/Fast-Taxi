...
internal fun TopControlView(
    ...
    Box(
        ...
        Column(
            modifier = Modifier.align(Alignment.TopCenter).windowInsetsPadding(WindowInsets.safeDrawing).padding(top = playerConfig.controlTopPadding) // Add padding to the top
        ) {
